...
export default {
    ...
    execute: async({ hisoka, m, prefix, command, commands }) => {
        if (m.args.length >= 1) {
            ...
            let teks = `Halo dek @${m.sender.split("@")[0]}, ini adalah daftar fitur yg tersedia\n\n`
            ...
            hisoka.sendMessage(m.from, 'https://telegra.ph/file/1ce330249e00c85124138.jpg', {
                caption: teks,
                quoted: m,
                ...
                extra: {
                    ctwaContext: {
                        ...
                        sourceUrl: 'https://instagram.com/moreegih',
                        thumbnail: (await Func.getFile('https://telegra.ph/file/1ce330249e00c85124138.jpg')).data.toString('base64'),
                        mediaType: 1
                    }
                }
            })
